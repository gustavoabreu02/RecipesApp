...
class ComponentFoods extends React.Component {
  render() {
    const {
      foodsIngredients,
      foodsName,
    ...
    return (
      <div className="body color">
        <div className="cardContainer">
          ...
          { foodsName.length === 1 ? (<Redirect to={ `/foods/${foodsName[0].idMeal}` } />)
            : (
...
export default connect(mapStateToProps)(ComponentFoods);
